...
Global Const smImageWidth = 16
Global Const smImageHeight = 22

Global Const lgImageWidth = 32
Global Const lgImageHeight = 45

Public Function Zeros(intNumZeros As Integer) As String
    Dim i As Integer
    
    For i = 0 To intNumZeros
        Zeros = Zeros & "0"
    Next
End Function
